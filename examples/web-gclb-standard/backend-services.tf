...
data "google_compute_region_instance_group" "gnae1-rcnginxfe-0igm" {
  name   = "gnae1-rcnginxfe-0igm"
  region = "northamerica-northeast1"
}

data "google_compute_region_instance_group" "guse4-rcnginxfe-0igm" {
  name   = "guse4-rcnginxfe-0igm"
  region = "us-east4"
}

data "google_compute_region_instance_group" "gsae1-rcnginxfe-0igm" {
  name   = "gsae1-rcnginxfe-0igm"
  region = "southamerica-east1"
}

data "google_compute_region_instance_group" "gnae1-cpsnginxfe-0igm" {
  name   = "gnae1-cpsnginxfe-0igm"
  region = "northamerica-northeast1"
}

data "google_compute_region_instance_group" "guse4-cpsnginxfe-0igm" {
  name   = "guse4-cpsnginxfe-0igm"
  region = "us-east4"
}

data "google_compute_region_instance_group" "gsae1-cpsnginxfe-0igm" {
...
resource "google_compute_backend_service" "rcnginxfe-global-all-poc-backend" {
  ...
  backend {
    balancing_mode               = "RATE"
    capacity_scaler              = 1
    group                        = data.google_compute_region_instance_group.gnae1-rcnginxfe-0igm.self_link
    max_connections              = 0
  ...
  backend {
    balancing_mode               = "RATE"
    capacity_scaler              = 1
    group                        = data.google_compute_region_instance_group.guse4-rcnginxfe-0igm.self_link
    max_connections              = 0
    max_connections_per_endpoint = 0
    max_connections_per_instance = 0
    max_rate                     = 0
...
resource "google_compute_backend_service" "rcnginxfe-global-gsae1-poc-backend" {
  ...
  backend {
    balancing_mode               = "RATE"
    capacity_scaler              = 1
    group                        = data.google_compute_region_instance_group.gsae1-rcnginxfe-0igm.self_link
    max_connections              = 0
    max_connections_per_endpoint = 0
    max_connections_per_instance = 0
    max_rate                     = 0
...
resource "google_compute_backend_service" "cpsnginxfe-global-all-poc-backend" {
  ...
  backend {
    balancing_mode               = "RATE"
    capacity_scaler              = 1
    group                        = data.google_compute_region_instance_group.gnae1-cpsnginxfe-0igm.self_link
    max_connections              = 0
    max_connections_per_endpoint = 0
    max_connections_per_instance = 0
    max_rate                     = 0
  ...
  backend {
    balancing_mode               = "RATE"
    capacity_scaler              = 1
    group                        = data.google_compute_region_instance_group.guse4-cpsnginxfe-0igm.self_link
    max_connections              = 0
    max_connections_per_endpoint = 0
    max_connections_per_instance = 0
    max_rate                     = 0
...
resource "google_compute_backend_service" "cpsnginxfe-global-gsae1-poc-backend" {
  ...
  backend {
    balancing_mode               = "RATE"
    capacity_scaler              = 1
    group                        = data.google_compute_region_instance_group.gsae1-cpsnginxfe-0igm.self_link
    max_connections              = 0
    max_connections_per_endpoint = 0
    max_connections_per_instance = 0
    max_rate                     = 0
